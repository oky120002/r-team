...
public class JTreeDemoForQQ {
	...
	public void initView() {
		...
		jframeFriendList.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		jtree.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (count != -1) {
					...
					if (e.getClickCount() == 2 && count != 0 && !strFriendUsername.equals("陌生人") && !strFriendUsername.equals("黑名单") && !strFriendUsername.equals("我的群")) {
