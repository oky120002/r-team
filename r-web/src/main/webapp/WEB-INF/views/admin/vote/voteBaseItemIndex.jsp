...
<script src="<c:url value="/res/js/admin/vote/voteBaseItemList.js" />" type="text/javascript"></script>
<title>问卷项管理</title>
</head>
<body>
	<div>
		<div class="dmenu" title="基础问卷项列表">
			<ul class="icon">
				<li title="问卷管理"><a href="<c:url value="/admin/vote/page/vote/index" />"><i class="ntt_li_ntiStart"></i>问卷管理</a></li>
				<li title="新增"><a href="<c:url value="/admin/vote/page/votebaseitem/add" />"><i class="ntt_li_ntiAdd"></i>新增</a></li>
			</ul> 
