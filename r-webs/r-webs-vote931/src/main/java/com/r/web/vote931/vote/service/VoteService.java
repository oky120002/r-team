...
public class VoteService extends AbstractService {
    ...
    public YesOrNoVoteItem createYesOrNoVoteItem(String question, boolean answer, String answerYes, String answerNo, String provider) {
        ...
        yesOrNoVoteItemDao.create(yesno);
        return yesno;
    }
     ...
     */
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class, readOnly = false)
    public SingleOptionVoteItem createSingleOptionVoteItem(String question, int answer, String answer1, String answer2, String answer3, String answer4, String provider) {
        ...
        singleOptionVoteItemDao.create(single);
        return single;
    }
