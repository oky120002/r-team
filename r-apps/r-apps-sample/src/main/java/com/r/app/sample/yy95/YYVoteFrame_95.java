 ...
 * 
 */
public class YYVoteFrame_95 extends HBaseFrame implements ActionListener {
    private static final long serialVersionUID = -7265881767861403989L;
    private static final String BODY_ENCODE = "utf-8";
    private static final Logger logger = LoggerFactory.getLogger(YYVoteFrame_95.class);
    private static final SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");
    private static final StrIntKV[] kvs = new StrIntKV[] { StrIntKV.accountKV("┊      ➣　　米　　　豆　　　❉　  ┊高冷帅气逗比豆         支持菇凉,支持931", 12541, null, "米豆"), //
            StrIntKV.accountKV("┊      ➣ 　 泡　　　泡 　　 ❉  　┊原创音乐人萌泡泡       支持菇凉,支持931", 11581, null, "泡泡"), //
            StrIntKV.accountKV("┊      ➣　　知　　　秋　　　❉　　┊粤语情歌邻家大叔       支持菇凉,支持931", 13105, null, "知秋"), //
            StrIntKV.accountKV("┊      ➣　　 ＡＬｉｎ　 　　❉　　┊星海学院的邓紫棋       支持菇凉,支持931", 12441, null, "alin"),//
            StrIntKV.accountKV("┊      ➣　  米      粒　　  ❉　　┊乖巧萝莉邻家乖女       支持菇凉,支持931", 11593, null, "米粒"),//
            StrIntKV.accountKV("┊      ➣　  胡  艾  彤　  　❉　　┊大叔不要跑原创者       支持菇凉,支持931", 12397, null, "彤彤"),//
            StrIntKV.accountKV("┊      ➣　　倾　　　城　　　❉　  ┊村里姑凉叫城锅         支持菇凉,支持931", 11589, null, "倾城"),//
            StrIntKV.accountKV("┊      ➣　　米　小　诺　　　❉　  ┊甜美乖巧萌妹纸         支持菇凉,支持931", 12345, null, "小诺"),//
            StrIntKV.accountKV("┊      ➣　  思  小  黛　  　❉　　┊古代穿越古筝美女       支持菇凉,支持931", 10597, null, "小黛"),//
            StrIntKV.accountKV("┊      ➣　　逍　　　瑶　　　❉　  ┊甜美声控系女生         支持菇凉,支持931", 11529, null, "逍遥"),//
            StrIntKV.accountKV("┊      ➣　　大  锅  饭　　　❉　  ┊专业舞蹈姐妹花         支持菇凉,支持931", 11945, null, "饭饭"),//
            StrIntKV.accountKV("┊      ➣　　丫　　　丫　　　❉　  ┊马栏山的女神丫         支持菇凉,支持931", 14497, null, "丫丫"),//
            StrIntKV.accountKV("┊      ➣    疯　小　兔　　　❉　  ┊温柔甜歌兔女郎         支持菇凉,支持931", 12497, null, "小兔"),//
            StrIntKV.accountKV("┊      ➣　　夕      夏　　　❉　  ┊来自西夏的夕夏         支持菇凉,支持931", 12073, null, "夕夏"),//
    }; // 投票对象数组

    private static final StrIntKV[] sudu = new StrIntKV[] { StrIntKV.accountKV("┊      ➣ 　 安心啦             每5秒1个账号          10M光纤,脚本能达到的速度               支持菇凉,支持931", 5, null, null), //
            StrIntKV.accountKV("┊      ➣ 　 超级安全           每10秒1个账号         一般网络,脚本能达到的速度              支持菇凉,支持931", 10, null, null), //
            StrIntKV.accountKV("┊      ➣ 　 安心啦             每5秒1个账号          10M光纤,脚本能达到的速度               支持菇凉,支持931", 5, null, null), //
            StrIntKV.accountKV("┊      ➣ 　 瞪着你             每1秒1个账号          好吧.这个速度明显有点异常了            支持菇凉,支持931", 1, null, null), //
            StrIntKV.accountKV("┊      ➣ 　 微笑哦             每3秒1个账号          电信内部网络,高手的脚本能达到的速度    支持菇凉,支持931", 3, null, null), //
