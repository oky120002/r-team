...
import com.r.app.sample.vote.view.VoteFrame;
...
public class YYVoteFrame extends HBaseFrame implements ActionListener {
	...
	// StrIntKV.accountKV("┊      ➣ 　 瞪着你             每1~2秒1个账号          好吧.这个速度明显有点异常了            支持菇凉,支持931",
	// 1, 2, null), //
	...
	private static final StrIntKV[] sudu2 = new StrIntKV[] { StrIntKV.accountKV("┊      ➣ 　 最爱菇凉           每11~16秒1个账号         一般拨号,脚本能达到的速度              支持菇凉,支持931", 11, 16, null), //
			StrIntKV.accountKV("┊      ➣ 　 心情舒畅           每8~13秒1个账号          10M拨号,脚本能达到的速度               支持菇凉,支持931", 8, 13, null), //
			StrIntKV.accountKV("┊      ➣ 　 安心啦             每5~10秒1个账号          10M光纤,脚本能达到的速度               支持菇凉,支持931", 5, 10, null), //
	...
	private VoteFrame voteFrame = new VoteFrame("菇凉问答测试"); // 投票窗口
	...
	private JButton btnvote = new JButton("菇凉问答题");
	...
	private void initComponents() {
		...
		HBaseBox center = HBaseBox.createVerticalBaseBox(new HBaseScrollPane(account), HBaseBox.EmptyVertical, new HBaseScrollPane(text));
		add(center, BorderLayout.CENTER);

		HBaseBox botton = HBaseBox.createHorizontalRight(jLabel1, HBaseBox.createHorizontalGlue(), jLabel2, btnvote, btnpiaoshu, btnstart);
